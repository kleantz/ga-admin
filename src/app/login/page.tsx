...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const DEFAULT_EMAIL = "admin@genassist.com"
    const DEFAULT_PASSWORD = "admin123"

    // Check credentials
    if (formData.email === DEFAULT_EMAIL && formData.password === DEFAULT_PASSWORD) {
      // Set auth cookie
      document.cookie = "auth-token=demo-token; path=/; max-age=2592000" // 30 days
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="admin@genassist.com"
                className="h-11"
              />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-sm text-[#5261FF] hover:text-[#4A56E8] font-medium"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#5261FF] focus:ring-[#5261FF] border-zinc-300 rounded"
              />
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 bg-[#5261FF] hover:bg-[#4A56E8] text-white"
            >
          ...
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <div className="space-y-1 text-sm text-blue-700">
              <p><span className="font-medium">Email:</span> admin@genassist.com</p>
          ...
          <div className="text-center">
            <p className="text-sm text-zinc-600">
              ...
              <button className="text-[#5261FF] hover:text-[#4A56E8] font-medium">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-[#5261FF] to-[#4A56E8] items-center justify-center p-12">
        <div className="max-w-md text-white space-y-6">
          <h2 className="text-4xl font-bold">
            Manage your GenAssist platform with ease
          </h2>
          <p className="text-lg text-white/90">
            Access powerful tools to manage accounts, users, workflows, and monitor your platform's performance.
          </p>
          <div className="space-y-4 pt-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Full control over all customer accounts and subscriptions</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Track usage, monitor activity, and gain insights</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">Monitor and manage all active workflows across accounts</p>
              </div>
            </div>
          </div>
        </div>
